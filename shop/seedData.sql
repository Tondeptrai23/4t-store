...
INSERT INTO sub_categories (categoryId, name, description, parentId, createdAt, updatedAt) VALUES
('101', N'Áo thun', N'Áo thun basic và thời trang, phù hợp mặc hàng ngày', '1', NOW(), NOW()),
('102', N'Áo sơ mi', N'Áo sơ mi công sở và casual cho nam nữ', '1', NOW(), NOW()),
('103', N'Áo polo', N'Áo polo thanh lịch và năng động, phù hợp nhiều dịp', '1', NOW(), NOW()),
('201', N'Quần jean', N'Quần jean thời trang nhiều kiểu dáng', '2', NOW(), NOW()),
('202', N'Quần shorts', N'Quần shorts năng động cho mùa hè', '2', NOW(), NOW()),
('203', N'Quần tây', N'Quần tây công sở thanh lịch', '2', NOW(), NOW()),
('301', N'Giày thể thao', N'Giày thể thao năng động nhiều thương hiệu', '3', NOW(), NOW()),
('302', N'Giày tây', N'Giày tây công sở sang trọng', '3', NOW(), NOW()),
('303', N'Dép', N'Dép đi trong nhà và đi biển', '3', NOW(), NOW()),
('401', N'Túi đeo chéo', N'Túi đeo chéo tiện lợi nhiều ngăn', '4', NOW(), NOW()),
('402', N'Balo', N'Balo thời trang đa năng', '4', NOW(), NOW()),
('403', N'Túi đeo vai', N'Túi đeo vai thời trang cho nữ', '4', NOW(), NOW()),
('501', N'Áo blazer', N'Áo blazer công sở thanh lịch', '5', NOW(), NOW()),
('502', N'Hoodie', N'Hoodie trẻ trung năng động', '5', NOW(), NOW()),
('503', N'Áo khoác dù', N'Áo khoác dù chống nước tiện lợi', '5', NOW(), NOW());

-- Products table
-- Products for Áo thun (categoryId: '101')
...
-- product_images for Áo thun products
...
-- Products for Áo sơ mi (categoryId: '102')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Áo sơ mi products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Áo polo (categoryId: '103')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Áo polo products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Quần jean (categoryId: '201')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Quần jean products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Quần shorts (categoryId: '202')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Quần shorts products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Quần tây (categoryId: '203')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Quần tây products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Giày thể thao (categoryId: '301')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Giày thể thao products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Giày tây (categoryId: '302')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Giày tây products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Dép (categoryId: '303')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Dép products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Túi đeo chéo (categoryId: '401')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Túi đeo chéo products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Balo (categoryId: '402')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Balo products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Túi đeo vai (categoryId: '403')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Túi đeo vai products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Áo blazer (categoryId: '501')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Áo blazer products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Hoodie (categoryId: '502')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Hoodie products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
...
-- Products for Áo khoác dù (categoryId: '503')
INSERT INTO products (productId, categoryId, name, description, price, size, color, createdAt, updatedAt) VALUES
...
-- product_images for Áo khoác products
INSERT INTO product_images (imageId, productId, contentType, displayOrder, path, createdAt, updatedAt) VALUES
